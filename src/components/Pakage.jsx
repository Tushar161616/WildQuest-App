  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-2 text-5xl font-bold tracking-tight text-balance text-gray-900 sm:text-6xl">
         Wildlife Packages
        </p>
      </div>
...
Discover forests, animals, and nature like never before.
    ...
    <div className='mt-6 flex flex-wrap items-center justify-center gap-20'>
